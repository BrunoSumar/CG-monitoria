...
const curva = (bezier, canvas, st, pr) => (c) => {
...
let curva1 = new p5(curva(bezier1, canvas1, statusB1, autoB1), canvas1);
let curva2 = new p5(curva(bezier2, canvas2, statusB2, autoB2), canvas2);
let curva3 = new p5(curva(bezier3, canvas3, statusB3, autoB3), canvas3);
